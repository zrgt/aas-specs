...
====
Note 2: extenss are proprietary, i.e. they do not support global interoperability.
====
...
Default for an element. That is that it is representing an instance.
